<div class="c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show" id="sidebar">
    <div class="c-sidebar-brand d-lg-down-none">
        ...
        <img  width="118" height="46" src="{{ asset('img/brand/food-serving.svg') }}">
    </div><!--c-sidebar-brand-->
    ...
    <ul class="c-sidebar-nav">
        ...
        @if ($logged_in_user->hasAllAccess())
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    ...
                    <li class="c-sidebar-nav-item">
                        <x-utils.link
                            ...
                            class="c-sidebar-nav-link"
                            :text="__('Blog Management')" />
                    </li>
                    <li class="c-sidebar-nav-item">
                        <x-utils.link
                            :href="route('admin.reservation')"
                            class="c-sidebar-nav-link"
                            :text="__('Reservation Management')" />
                    </li>
            ...
            <li class="c-sidebar-nav-dropdown">
                <x-utils.link
                    href="#"
                    icon="c-sidebar-nav-icon cil-restaurant"
                    class="c-sidebar-nav-dropdown-toggle"
                    :text="__('Kitchen Department')" />
